...
- Shiki syntax highlighting for Go, bash, YAML, SQL, and GraphQL
- Docker development setup (Dockerfile + compose.yaml)
- GitHub Actions CI with Vercel deployment (production on push to main, preview on PRs)
