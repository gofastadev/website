...
description: Generate a model, migration, repository interface, and repository implementation for database access. Stops short of the service / controller / routes layers — use when you need data access without exposing the resource over HTTP yet.
keywords:
  - "generate repository"
  - "data access layer"
  - "repository pattern"
...
<RelatedPages path="cli-reference/generate/repository" />
