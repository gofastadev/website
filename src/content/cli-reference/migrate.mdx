...
<RelatedPages
  path="cli-reference/migrate"
  extra={[
    { href: "/docs/cli-reference/new/driver", label: "`gofasta new --driver`" },
    { href: "/docs/cli-reference/generate/migration", label: "`gofasta g migration`" },
  ]}
/>
