...
description: Print every registered REST route in the project as a formatted table — method, path, handler, and any chained middlewares. Reads the route registrations statically (no running server needed) so you can audit your API surface in CI.
keywords:
  - "CLI"
  - "routes"
  - "REST routes"
...
<RelatedPages
  ...
  extra={[
    { href: "/docs/guides/rest-api", label: "REST API Guide" },
    { href: "/docs/cli-reference/generate/route", label: "gofasta generate route" },
  ]}
/>
