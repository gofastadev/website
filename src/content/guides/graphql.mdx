...
<RelatedPages
  path="guides/graphql"
  extra={[
    { href: "/docs/api-reference/graphql", label: "pkg/graphql — schema fragments" },
    { href: "/docs/api-reference/types", label: "pkg/types" },
    { href: "/docs/cli-reference/generate/resolver", label: "gofasta g resolver" },
  ]}
/>
