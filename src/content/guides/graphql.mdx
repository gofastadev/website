...
Gofasta includes GraphQL support powered by [gqlgen](https://gqlgen.com/), a type-safe Go GraphQL server library. Your project ships with a working GraphQL endpoint alongside the REST API, both sharing the same services and repositories.
