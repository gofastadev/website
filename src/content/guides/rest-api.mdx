---
title: Building REST APIs with chi
...
<RelatedPages
  ...
  extra={[
    { href: "/docs/api-reference/http-utilities", label: "pkg/httputil" },
    { href: "/docs/api-reference/middleware", label: "pkg/middleware" },
    { href: "/docs/cli-reference/generate/controller", label: "gofasta g controller" },
  ]}
/>
