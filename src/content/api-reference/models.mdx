---
title: pkg/models — BaseModel with UUID, soft delete, optimistic lock
description: Drop-in BaseModelImpl struct that gives every domain model UUID v7 primary keys, auto-managed CreatedAt/UpdatedAt/DeletedAt, optimistic locking via RecordVersion, plus IsActive and IsDeletable flags — all enforced by GORM hooks and DB-level triggers.
keywords:
  - "models API"
  - "GORM"
  - "BaseModel"
...
<RelatedPages path="api-reference/models" />
