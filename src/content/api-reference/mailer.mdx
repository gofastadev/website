---
title: pkg/mailer — SMTP, SendGrid, and Brevo email
description: Pluggable outbound email with three drivers (SMTP, SendGrid, Brevo), HTML template rendering via Go html/template, attachment support, and a queue-aware Send so transactional email composes naturally with pkg/queue.
keywords:
  - "mailer API"
  - "email sending"
  - "SMTP"
...
<RelatedPages path="api-reference/mailer" />
