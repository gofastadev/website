---
title: "pkg/storage — Local + S3-compatible file storage"
description: "File storage abstraction with two drivers: local filesystem (for dev) and S3-compatible (AWS S3, MinIO, R2, B2). Upload, Download, Delete, presigned URL generation, and content-type detection — same API across drivers."
keywords:
  - "storage API"
  - "file storage"
  - "S3 storage"
...
<RelatedPages path="api-reference/storage" />
