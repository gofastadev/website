---
title: pkg/i18n — go-i18n with YAML locale files
description: Internationalization backed by go-i18n — load translations from per-locale YAML files under locales/, resolve language preference from the Accept-Language header, and render messages with pluralization and template variables.
keywords:
  - "i18n API"
...
<RelatedPages path="api-reference/i18n" />
