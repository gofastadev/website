---
title: pkg/utils — Pagination, string, and query helpers
description: Helper functions shared across the gofasta packages — pagination math (offset + limit normalization, total page count), string case conversions (snake/camel/kebab), GORM query builders for sort + filter, and small functional helpers.
keywords:
  - "utils API"
  - "helper functions"
  - "pagination helpers"
...
<RelatedPages path="api-reference/utils" />
