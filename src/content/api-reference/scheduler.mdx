---
title: pkg/scheduler — Cron jobs via robfig/cron
description: Cron-based job scheduling powered by robfig/cron with 6-field expressions (seconds included) — register periodic jobs, manage their lifecycle, and integrate with pkg/queue when scheduled work fans out to async tasks.
keywords:
  - "scheduler API"
  - "cron jobs"
  - "robfig/cron"
...
<RelatedPages path="api-reference/scheduler" />
