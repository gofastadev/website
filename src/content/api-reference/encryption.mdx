---
title: pkg/encryption — AES-256-GCM encryption at rest
description: Symmetric AES-256-GCM encryption and decryption for sensitive fields stored at rest — encrypted database columns, encrypted file payloads, encrypted session blobs. Authenticated encryption with random nonces; safe defaults, no knobs to mis-tune.
keywords:
  - "encryption API"
  - "cryptography"
  - "AES-256-GCM"
...
<RelatedPages path="api-reference/encryption" />
