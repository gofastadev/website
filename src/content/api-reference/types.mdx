---
title: pkg/types — Shared DTOs, pagination, and common API shapes
description: Common cross-package types — TPaginationInputDto, TSortingInputDto, TPaginationObjectDto, TCommonAPIErrorDto, TCommonResponseDto, and the SortOrientation enum — keep API shapes consistent across every resource the scaffold generates.
keywords:
  - "types API"
  - "shared DTOs"
  - "pagination types"
...
<RelatedPages path="api-reference/types" />
