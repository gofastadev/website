---
title: pkg/websocket — WebSocket hub with rooms + broadcasting
description: WebSocket server with a Hub abstraction — connection registry, room-based broadcasting, per-client lifecycle hooks, and built-in JSON message framing. Drop-in for real-time features (chat, live notifications, presence) on top of net/http.
keywords:
  - "WebSocket API"
  - "real-time"
  - "WebSocket hub"
...
<RelatedPages path="api-reference/websocket" />
