---
title: "pkg/health — Liveness, readiness, and dependency probes"
description: "Three first-class HTTP probe endpoints: /health (overall), /health/live (process up), /health/ready (DB + cache + dependencies). Designed for Kubernetes, Docker Swarm, uptime monitors, and load balancers — with per-dependency status in the JSON response."
keywords:
  - "health API"
  - "health check"
  - "readiness probe"
...
<RelatedPages path="api-reference/health" />
