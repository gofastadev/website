---
title: Introduction
description: Gofasta is a Go backend toolkit — a CLI for scaffolding production-shaped projects and a library of independent pkg/* packages. Built agent-native with AGENTS.md, structured CLI output, and a debug surface designed for AI coding assistants to use directly.
keywords:
  - "introduction"
  - "getting started"
  - "overview"
...
<RelatedPages path="getting-started/introduction" />
