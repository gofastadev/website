...
|------|---------|---------------|
| [Wire](https://github.com/google/wire) | Compile-time dependency injection | `go install` (as a Go tool) |
| [gqlgen](https://github.com/99designs/gqlgen) | GraphQL code generation | `go install` (as a Go tool) |
| [Air](https://github.com/air-verse/air) | Hot reload during development | `go install` (as a Go tool) |
