---
title: Installation
description: Install the Gofasta CLI via Homebrew, the official install script, or `go install`. Covers macOS, Linux, and Windows (WSL); verifying the install with `gofasta doctor`; and the optional shell completion for bash, zsh, and fish.
keywords:
  - "install Gofasta"
  - "CLI install"
  - "Homebrew install"
