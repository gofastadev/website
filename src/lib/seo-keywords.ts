...
const PAGE_KEYWORDS: Record<string, string[]> = {
  ...
  "/docs/guides/debugging/overview": [
    "debugging",
    "debug dashboard",
    "devtools build tag",
  ...
  "/docs/guides/debugging/guided-tour": [
  ...
  "/docs/guides/debugging/dashboard-panels": [
    "dashboard panels",
    "Recent requests",
    "Recent SQL",
    "Traces panel",
  ...
  "/docs/guides/debugging/architecture": [
  ...
  "/docs/guides/debugging/customization": [
    "ring buffer sizes",
    "ringCapacity",
    "traceRingCapacity",
