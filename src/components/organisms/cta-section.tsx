...
export function CtaSection() {
  ...
  return (
    <section className="px-6 py-20 sm:py-28">
      <div className="relative mx-auto max-w-5xl overflow-hidden rounded-3xl border border-primary/30 bg-gradient-to-br from-primary/10 via-transparent to-primary/5 p-10 text-center sm:p-16 dark:from-primary/20 dark:to-primary/10">
        <div
          aria-hidden="true"
        ...
        <p className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-gray-600 dark:text-gray-400 sm:text-lg">
          Scaffold a production Go backend in the next five minutes. No
          signup, no dashboard, no proprietary runtime. Just{" "}
