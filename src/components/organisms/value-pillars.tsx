...
const pillars = [
  ...
  },
  {
    ...
    description:
      "Every command accepts --json. Every error carries a stable code. A scaffolded AGENTS.md briefs any AI coding agent on your project's conventions. One command — gofasta ai install claude — configures Claude Code, Cursor, Codex, Aider, or Windsurf. Humans and agents work the same way.",
    icon: (
      <svg {...iconProps}>
