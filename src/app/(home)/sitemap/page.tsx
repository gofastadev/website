...
const sections = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/docs/guides/deployment/coolify", label: "Deploy to Coolify" },
      { href: "/docs/guides/deployment/dokploy", label: "Deploy to Dokploy" },
      { href: "/docs/guides/deployment/kamal", label: "Deploy with Kamal" },
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/docs/cli-reference/debug", label: "gofasta debug" },
      { href: "/docs/cli-reference/ai", label: "gofasta ai" },
      { href: "/docs/cli-reference/verify", label: "gofasta verify" },
      { href: "/docs/cli-reference/status", label: "gofasta status" },
      { href: "/docs/cli-reference/inspect", label: "gofasta inspect" },
      { href: "/docs/cli-reference/do", label: "gofasta do" },
      { href: "/docs/cli-reference/config", label: "gofasta config" },
      ...
      { href: "/docs/cli-reference/db", label: "gofasta db" },
      { href: "/docs/cli-reference/deploy", label: "gofasta deploy" },
      { href: "/docs/cli-reference/wire", label: "gofasta wire" },
      { href: "/docs/cli-reference/swagger", label: "gofasta swagger" },
      { href: "/docs/cli-reference/routes", label: "gofasta routes" },
      { href: "/docs/cli-reference/console", label: "gofasta console" },
      { href: "/docs/cli-reference/doctor", label: "gofasta doctor" },
      { href: "/docs/cli-reference/upgrade", label: "gofasta upgrade" },
      { href: "/docs/cli-reference/version", label: "gofasta version" },
    ],
  },
  {
